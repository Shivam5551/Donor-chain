...
export const FancyButton = (button: Button) => {
    return (
      <div className="w-full justify-center flex h-10 ">
    <button
        style={{WebkitBoxReflect: "-webkit-box-reflect: below 0px linear-gradient(to bottom, rgba(0,0,0,0.0), rgba(0,0,0,0.4));"}}
        className="px-10 py-3 bg-gradient-to-r from-red-500 to-orange-500 rounded-full shadow-xl group-hover:shadow-2xl group-hover:shadow-red-600 shadow-red-600 uppercase font-serif tracking-widest relative overflow-hidden group text-transparent cursor-pointer z-10 after:absolute after:rounded-full after:bg-red-200 after:h-[85%] after:w-[95%] after:left-1/2 after:top-1/2 after:-translate-x-1/2 after:-translate-y-1/2 hover:saturate-[1.15] inline-flex active:saturate-[1.4]"
        >   
        {
            button.isSubmitting ? <Loading/> : 
            <>
                Button
                <p
                    className="absolute z-50 font-semibold bg-gradient-to-r from-blue-500 to-black bg-clip-text text-transparent top-1/2 left-1/2 -translate-x-1/2 group-hover:-translate-y-full h-full w-full transition-all duration-300 -translate-y-[30%] tracking-widest"
                >
                    WELCOME
                </p>
                <p
                    className="absolute z-50 top-1/2 left-1/2 bg-gradient-to-r from-blue-700 to-black bg-clip-text text-transparent -translate-x-1/2 translate-y-full h-full w-full transition-all duration-300 group-hover:-translate-y-[40%] tracking-widest font-extrabold"
                >
                    {button.title}
                </p>
                <svg
